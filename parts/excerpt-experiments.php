<?php
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('cf ' . $styleClass); ?> role="article" <?php echo $inlineCSS; ?> itemscope itemtype="https://schema.org/BlogPosting">
	...
	<section class="excerpt-info">
		...
		$date     = get_post_meta($post->ID, '_jcg_release_date', true);
