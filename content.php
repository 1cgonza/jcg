                      ...
                      <?php
                        ...
                        if($categories){
                          foreach($categories as $category) {
                            echo '<p class="cat-item cat-item-' . $category->term_id . '"><a href="' . get_category_link( $category->term_id ) . '" title="' . esc_attr( sprintf("View all posts in %s", $category->name) ) . '">' . $category->cat_name . '</a></p>';
                          }
                        }
                      ?>
                    </div>
